...
import 'package:pgi_mobile/screens/AffectationInventory/search_material.dart';
...
class ScanImmoAffectation extends StatelessWidget {
  const ScanImmoAffectation({Key? key}) : super(key: key);
    ...
    if (list is bool) {
      ...
      list.forEach((element) {
        ...
        Navigator.pushReplacement(context,
            MaterialPageRoute(builder: (context) => const MaterialStateImmo()));
      });
      return list;
    }
  }
