...
class ObservationAffectation extends StatelessWidget {
  const ObservationAffectation({Key? key}) : super(key: key);
...
//enregistre les observations dans le local storage
                    ...
                    onPressed: () async {
                      await saveObservation(text.text).whenComplete(() =>
                          Navigator.pushReplacement(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => const RecapInfo())));
                    },
