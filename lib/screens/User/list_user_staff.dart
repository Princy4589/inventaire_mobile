...
class ListUserAffectedExtension extends StatefulWidget {
  const ListUserAffectedExtension({Key? key}) : super(key: key);

  @override
  State<ListUserAffectedExtension> createState() =>
      _ListUserAffectedExtensionState();
}

class _ListUserAffectedExtensionState extends State<ListUserAffectedExtension> {
                    ...
                    onTap: () {
                      Navigator.push(
                          ...
                          PageTransition(
                              ...
                              child: const ScanImmoAffectation()));
