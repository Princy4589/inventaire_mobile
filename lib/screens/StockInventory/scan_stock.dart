...
import 'package:pgi_mobile/screens/StockInventory/search_material.dart';
...
class ScanStock extends StatelessWidget {
  const ScanStock({Key? key}) : super(key: key);
    ...
    if (result != null) {
      ...
      await setImmo(userEntry['code_immo']).whenComplete(() {
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => const StateMaterial(),
          ),
        );
        controller!.dispose();
      });
